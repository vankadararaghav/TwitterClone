...
<html lang="en" class=""><head>
      ...
      <style class="INLINE_PEN_STYLESHEET_ID">
        ...
        --background: #ffffff;
            ...
            --cs-surface-2: #eef4f8;
            --cs-separator: #e8ecf0;
            --cs-on-surface-primary: #00000094;
   ...
   <body>
    <jsp:include page="templates/html.jsp" />
      <div id="root">
         <div>
            <div class="layout">
            ...
            <c:forEach var="tweet" items="${TWEETS}" varStatus="loopCounter" >
                <div class="feed_item">
                       <div class="joke">
                          <div class="joke_wrapper">
                             <div class="joke_block joke_block--header">
                                <span class="joke_element joke_element--author-name">${tweet.followerName}</span><span class="joke_element joke_element--author-username">${tweet.followerEmail}</span>
                                <div class="joke_element joke_element--author-img"><img src="/static/images/default-user.jpg"></div>
                             </div>
                             <div class="joke_block joke_block--text">${tweet.tweet}</div>
                             <div class="joke_block joke_block--footer">
                                <ul class="nav nav--joke_rebound">

                                   <li class="nav_item  retweet" id="${tweet.tweet_id}">
      ...
      $("#create-tweet").click( function(){
         var  data = document.getElementById("tweet-message").value;
         if(data.length!=0){
          $.ajax({
                     type: "POST",
