...
<html lang="en" class=""><head>
   ...
   <body>
      ...
      <div id="root">
         <div>
            <div class="layout">
             ...
             <c:forEach var="member" items="${RECOMMENDATIONS}" varStatus="loopCounter" >
                     <div class="feed_item">
                        <div class="joke">
                            <div class="joke_wrapper">
                                ...
                                <c:if test="${is_followed}">
                                      <button class="follow-user Followed_button" member-id="${member.id}" type="submit" tabindex="0">
                                         <span tabindex="-1">Following</span>
                                      </button>
                                </c:if>
                                <c:if test="${!is_followed}">
                                   <button class="follow-user" member-id="${member.id}" type="submit" tabindex="0">
      ...
      $(".follow-user").click( function(){
          var button = this;
          var hasClass = this.classList.contains('Followed-button');
