...
public class Follower extends org.jooq.impl.TableImpl<tech.codingclub.helix.tables.records.FollowerRecord> {
	...
	private static final long serialVersionUID = -134251981;
	...
	public java.util.List<org.jooq.ForeignKey<tech.codingclub.helix.tables.records.FollowerRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<tech.codingclub.helix.tables.records.FollowerRecord, ?>>asList(tech.codingclub.helix.Keys.FOLLOWER__CONSTRAINTS, tech.codingclub.helix.Keys.FOLLOWER__CONSTRAINT2);
	}
